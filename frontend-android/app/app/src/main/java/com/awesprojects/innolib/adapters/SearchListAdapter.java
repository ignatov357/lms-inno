...
public class SearchListAdapter extends RecyclerView.Adapter<SearchListAdapter.SearchListItemHolder> {
    ...
    public SearchListItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View seacrhView = mLayoutInflater.inflate(R.layout.home_search_list_element,parent,false);
        return new SearchListItemHolder(seacrhView);
    }
    ...
    protected static class SearchListItemHolder extends RecyclerView.ViewHolder{
        ...
        private int getImageResource(int type){
            switch (type){
                case 0: return R.drawable.ic_library_books_black_36dp;
                case 1: return R.drawable.ic_insert_drive_file_black_36dp;
                case 2: return R.drawable.ic_video_library_black_36dp;
            }
            return 0;
        }
